...
\hline
\end{tabular}
\captionof{table}{Authority Weights Update}
\end{minipage}
...
\hline
\end{tabular}
\captionof{table}{Updating Hub Weights}
\end{minipage}
...
\hline
\end{tabular}
\captionof{table}{Final Authority Weights Update}
\end{minipage}
\end{document}